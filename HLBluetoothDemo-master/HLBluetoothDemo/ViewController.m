...
//                }];
    ...
    manager.discoverPeripheralBlcok = ^(CBCentralManager *central, CBPeripheral *peripheral, NSDictionary *advertisementData, NSNumber *RSSI) {
        ...
        NSLog(@"蓝牙个数：%ld",self.deviceArray.count);
    };
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    UIImage * Image = [UIImage imageNamed:@"dayin-jieche.jpg"];
    UIImage * myiange = [Image imageWithscaleMaxWidth:520];
    self.myImages.image = myiange;
